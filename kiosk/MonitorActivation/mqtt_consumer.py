...
class MqttConsumer(object):
    ...
    def reconnect(self):
        ...
        if not self._closing:
            ...
            self._connectioin = self.connect()
    ...
    def on_channel_closed(self, channel, reply_code, reply_text):
        ...
        different parameters. In this case, we will close the connection
    ...
    def on_queue_declareok(self, method_frame):
        ...
        setup_queue has completed. In this method we will bind the queue and
        exchange together with the routing key by issuing the Queue.Bind RPC
        command. When this command is complete, the on_bindok method will be invoked by pika.
    ...
    def add_on_cancel_callback(self):
        ...
        for some reason. If RabbitMQ does cancel the consumer, on_consumer_canceled 
        will be invoked by pika.
        """
    ...
    def on_message(self, unused_channel, basic_deliver, properties, body):
        ...
        channel is passed fro your convenience. The basic_deliver object that is 
        passed in carries the exchange, routing key, delivery tag and
        a redelivered flag for the message. The properties passed in is an instance
        of BasicProperties with the message properties and the body is the message
        that was sent.
        ...
        LOGGER.info('Received message # %s from %s: %s', basic_deliver.delivery_tag,
    ...
    def run(self):
        """
        Run the consumer by connecting to RabbitMQ and then starting the IOLoop to block
    ...
    def stop(self):
        ...
        connection. The IOLoop is started again because thsi method is invoked
